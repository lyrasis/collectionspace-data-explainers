...
Further, currently (as of v7.2), there is a fairly significant limitation in CollectionSpace advanced search when searching on fields controlled by authority vocabularies.
